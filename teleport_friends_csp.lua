...
local teleportApp = ui.addSettings({
  ...
  if #players == 0 then
    ...
    -- CHILD WINDOW (listenin tamamı): arka planı neredeyse görünmez.
    ui.pushStyleColor(ui.StyleColor.ChildBg, rgbm(0, 0, 0, 0.015))
    ...
    ui.childWindow(
      ...
      function()
        for _, player in ipairs(players) do
          ...
          -- Normalde satır + yazı neredeyse görünmez.
          -- Mouse üzerine gelince ikisi de belirginleşir.
          ui.pushStyleColor(ui.StyleColor.Button, rgbm(1, 1, 1, 0.015))
          ui.pushStyleColor(ui.StyleColor.ButtonHovered, rgbm(1, 1, 1, 0.38))
          ui.pushStyleColor(ui.StyleColor.ButtonActive, rgbm(1, 1, 1, 0.55))
          ui.pushStyleColor(ui.StyleColor.Text, rgbm(1, 1, 1, 0.035))
