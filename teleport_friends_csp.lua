...
--   * Trafik / AI araçlarını listelemez.
...
local function refreshPlayers()
  ...
  local function addCar(car, index)
    ...
    -- TRAFİK / AI araçlarını listeye alma.
    -- isHidingLabels, CSP'de trafik gibi davranan araçlar için de
    -- kullanılan bir durumdur. isAIControlled ise AI kontrolündeki
    -- araçları ayrıca filtreler.
    local isTraffic = false
    local isAI = false

    pcall(function()
      isTraffic = car.isHidingLabels == true
    end)

    pcall(function()
      isAI = car.isAIControlled == true
    end)

    if isTraffic or isAI then
      return
    end
